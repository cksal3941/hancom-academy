...
/notice/write                   → NoticeWritePage
/notice/:noticeId               → NoticeDetailPage
/notice/:noticeId/edit          → NoticeEditPage
/notice/start                   → OpeningNoticePage
/notice/start/write             → OpeningNoticeWritePage
...
services/
  ...
  noticeService.js   — Firestore CRUD + Storage image upload for notices and opening-notices;
                       falls back to static noticeData / openingNewsData when Firebase is unconfigured
  newsService.js     — Firestore CRUD + Storage image upload for news; falls back to newsData
hooks/
