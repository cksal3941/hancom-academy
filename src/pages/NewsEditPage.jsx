...
export default function NewsEditPage() {
  ...
  if (!loading && notFound) return <Navigate to="/news" replace />
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitError('')
    try {
      await updateNews(newsId, { category, title, content, imageFiles, existingImages })
        ...
        <div className="notice-board__inner">
          <form className="nw-form" onSubmit={handleSubmit} noValidate>
            <div className="nw-form__row">
              <label className="nw-form__label" htmlFor="ne-news-category">분류</label>
              <select
                id="ne-news-category"
            ...
            <div className="nw-form__row nw-form__row--full">
              <label className="nw-form__label" htmlFor="ne-news-title">제목</label>
                  ...
                  <ul className="nw-images__preview">
                    {existingImages.map((url, i) => (
                      <li key={url} className="nw-images__thumb">
                        ...
                        <button type="button" className="nw-images__remove" aria-label="이미지 제거" onClick={() => removeExistingImage(i)}>
                          <FiX />
                        </button>
                      </li>
                    ))}
                    {previews.map((src, i) => (
                      <li key={src} className="nw-images__thumb">
                        ...
                        <button type="button" className="nw-images__remove" aria-label="이미지 제거" onClick={() => removeNewImage(i)}>
                          <FiX />
                        </button>
                      </li>
                    ))}
            ...
            <div className="nw-form__row nw-form__row--content nw-form__row--full">
              <label className="nw-form__label" htmlFor="ne-news-content">내용</label>
              <div className="nw-form__field">
                <textarea
                  id="ne-news-content"
